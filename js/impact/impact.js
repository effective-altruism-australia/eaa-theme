...
var usdToAudExchangeRate = 0.758;

// Against Malaria Foundation (AMF)
var amfCostPerNetUsd = 4.22;
var amfPeopleProtectedPerNet = 1.8;
var amfCostPerLifeSavedUsd = 2835;

// Deworm the World
var dtwCostPerChildDewormedUsd = 0.46

// Give GiveDirectly
var gdOverheadPercent = 0.12
var gdHouseholdYearlyIncomeUsd = 1000

// Schistosomiasis Control Initiative (SCI)
var sciCostPerChildProtectedUsd = 0.46
...
var DATABASE = {
  "charities" : [
    ...
    "id" : "amf",
    "overhead" : 0.000,
    "infoURL" : "https://effectivealtruism.org.au/partner-charities",
    ...
    "numbers" : "It costs around AUD 3.32 for " + buildUrl("https://www.againstmalaria.com/DollarsPerNet.aspx", "AMF to buy one LLIN") + ". When the costs of AMF's distribution partners are taken into account, it is estimated that AUD 5.57 will cover the cost of purchase and distribution of one LLIN. On average this will protect " + buildUrl("http://www.givewell.org/international/technical/programs/insecticide-treated-nets#HowcosteffectiveisLLINdistribution", "1.8 people for 2.22 years") + ". While it's difficult to accurately determine how much it costs for a program to save a life, the charity research organisation GiveWell has suggested that every AUD 3740 donated to AMF, causes health benefits equivalent to saving one life. All public donations to AMF are used exclusively to fund bed nets, so AMF has an effective overhead rate of 0% (non-net costs are fundraised for separately). <br/><br/> You can learn more about AMF in this " + buildUrl("https://effectivealtruism.org.au/why-amf-is-so-popular-with-effective-altruists/", "blog post") + ".",
    "pricePoints" :   [
        {
    ...
    "numbers" : "Deworm the World protects children from parasitic worms for an annual cost of between AUD 0.05 to AUD 0.75 per child (not including drug costs or government costs), depending on " + buildUrl("https://docs.google.com/spreadsheets/d/1s0VHKhgfvx4JWzcYdtNO8OGK-arQadIOZzLKuCfz1CI/edit#gid=509033857", "geographic location") + ". " + buildUrl("https://www.evidenceaction.org/dewormtheworld#the-evidence-for-deworming", "A randomized trial in Kenya") + " found that deworming reduced student absenteeism by 25%, increased future wage earnings by 23% and increased adult work hours by 12%. " + buildUrl("http://scholar.harvard.edu/files/kcroke/files/ug_lr_deworming_071714.pdf", "A recent study") + " from the Harvard School of Public Health found that students in deworming treatment areas performed better on literacy and numeracy tests as compared with other students 7-8 years after the end of their deworming treatment. A thorough discussion of the strengths and weaknesses of the evidence behind deworming can be found " + buildUrl("http://blog.givewell.org/2016/12/06/why-i-mostly-believe-in-worms/", "here") + ".<br/><br/> You can learn more about Deworm the World in this " + buildUrl("https://effectivealtruism.org.au/whats-the-big-deal-about-deworming/", "blog post"),
    "pricePoints" :   [
        {
        ...
        "color" : "red",
        "text" :   {
          "fraction": "*% of the cost of deworming one child (estimate costs going forward not including drug costs or government costs)",
          "single" : "Deworm a child (estimate costs going forward not including drug costs or government costs)",
          "plural" : "Deworm * children (estimate costs going forward not including drug costs or government costs)"
          }
        }
      ]
    },
